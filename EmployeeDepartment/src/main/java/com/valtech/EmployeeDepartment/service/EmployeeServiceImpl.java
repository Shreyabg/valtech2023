...
public class EmployeeServiceImpl implements EmployeeService {
	...
	public void populateEmployee() {
		...
		Employee emp = new Employee("Shreya",21,1,1,45000);
		Employee emp1 = new Employee("Kavya",20,1,1,45000);
		Employee emp2 = new Employee("Poojitha",22,1,1,45000);
		Employee emp3 = new Employee("john",20,1,1,45000);
		Employee emp4 = new Employee("Michel",22,1,1,45000);
		Employee emp5 = new Employee("Dazy",22,1,1,45000);
